#ifndef CAFFE_CIRCLE_LSTM_LAYER_HPP_
#define CAFFE_CIRCLE_LSTM_LAYER_HPP_
...
class CircleLSTMLayer : public RecurrentLayer<Dtype> {
 public:
  explicit CircleLSTMLayer(const LayerParameter& param)
...
/**
 * @brief A helper for CircleLSTMLayer: computes a single timestep of the
...
#endif  // CAFFE_CircleLSTM_LAYER_HPP_
